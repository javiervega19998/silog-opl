...
function openHoja(id){
  ...
  document.getElementById('hoja-patente').textContent=`${_hojaActual.patente||'-'} \xB7 ${_hojaActual.distribuidor||'Sin distribuidor'}`;
  ...
  document.getElementById('hoja-horario').textContent=`${hi?formatTime(hi):'-'} - ${ht?formatTime(ht):'-'} \xB7 KM: ${_hojaActual.km_inicial||0}-${_hojaActual.km_final||0} (${_hojaActual.km_recorridos||0} km)`;
